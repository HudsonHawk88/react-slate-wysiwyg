...
export const Wysiwyg = ({
    ...
    editor.deleteBackward = (unit) => {
      ...
      if (selection && Range.isCollapsed(selection)) {
        const [cell] = SlateEditor.nodes(editor, {
          match: (n: any) =>
            !SlateEditor.isEditor(n) && n.type === "table-cell",
        });
  ...
  const withImages = (editor: SlateEditor) => {
    ...
    editor.isVoid = (element: any) => {
      return element.type === "image" ||
        element.type === "image-center" ||
        element.type === "image-right" ||
  ...
  const editor: any = useMemo(
    () =>
      withImages(
        withTables(withInlines(withHistory(withReact(createEditor()))))
      ),
    []
  );
  ...
  const isParentHeading = (props: any) => {
    ...
    if (parent) {
      if (
        ...
        parent.type === "heading-2" ||
        parent.type === "heading-3" ||
        parent.type === "heading-4" ||
        parent.type === "heading-5"
      ) {
        return true;
      } else {
        return false;
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <Input
                ...
                id="tableClass"
                onChange={(e) =>
                  setModalvalues({ ...modalValues, tableClass: e.target.value })
                }
                value={modalValues.tableClass}
              />
            </div>
            <div className="col-md-12">
              ...
              <Input
                ...
                id="rowNumber"
                onChange={(e) =>
                  setModalvalues({ ...modalValues, rowNumber: e.target.value })
                }
                value={modalValues.rowNumber}
              />
            </div>
            <div className="col-md-12">
              ...
              <Input
                ...
                id="colNumber"
                onChange={(e) =>
                  setModalvalues({ ...modalValues, colNumber: e.target.value })
                }
                value={modalValues.colNumber}
              />
            </div>
            <div className="col-md-12">
              <Label for="textAlign">
                Táblázat cellaszövegének igazítása:{" "}
              </Label>
              <Input
                type="select"
                name="textAlign"
                id="textAlign"
                onChange={(e) =>
                  setModalvalues({ ...modalValues, textAlign: e.target.value })
                }
                value={modalValues.textAlign}
              >
        ...
        <ModalFooter>
          <Button
            onClick={() =>
              addTablazat(
                editor,
                modalValues.tableClass,
                parseInt(modalValues.rowNumber, 10),
                parseInt(modalValues.colNumber, 10),
                modalValues.textAlign
              )
            }
          >
            Mentés
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <Input
                ...
                id="linkUrl"
                onChange={(e) =>
                  setModalvalues({ ...modalValues, linkUrl: e.target.value })
                }
                value={modalValues.linkUrl}
              />
            </div>
            <div className="col-md-12">
              ...
              <Input
                ...
                id="linkDesc"
                onChange={(e) =>
                  setModalvalues({ ...modalValues, linkDesc: e.target.value })
                }
                value={modalValues.linkDesc}
              />
            </div>
            <div className="col-md-12">
          ...
          <Button
            onClick={() =>
              insertLink(
                editor,
                modalValues.linkUrl,
                modalValues.linkDesc,
                modalValues.linkFontColor
              )
            }
          >
            Mentés
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <Input
                ...
                id="youtubeUrl"
                onChange={(e) =>
                  setModalvalues({ ...modalValues, youtubeUrl: e.target.value })
                }
                value={modalValues.youtubeUrl}
              />
            </div>
            <div className="col-md-12">
          ...
          <div className="row">
            <div className="col-md-12">
              ...
              <Input
                ...
                id="CTALeiras"
                onChange={(e) =>
                  setModalvalues({ ...modalValues, CTALeiras: e.target.value })
                }
                value={modalValues.CTALeiras}
              />
            </div>
            <div className="col-md-12">
              ...
              <Input
                ...
                id="CTAFunc"
                onChange={(e) =>
                  setModalvalues({ ...modalValues, CTAFunc: e.target.value })
                }
                value={modalValues.CTAFunc}
              />
            </div>
            <div className="col-md-12">
              ...
              <Input
                ...
                id="CTABgColor"
                onChange={(e) =>
                  setModalvalues({ ...modalValues, CTABgColor: e.target.value })
                }
                value={modalValues.CTABgColor}
              />
            </div>
            <div className="col-md-12">
        ...
        <ModalFooter>
          <Button
            onClick={() =>
              addCTA(
                editor,
                modalValues.CTALeiras,
                modalValues.CTAFunc,
                modalValues.CTAFontColor,
                modalValues.CTABgColor
              )
            }
          >
            Mentés
