    ...
    (
        ...
        const Leaf = (props: any) => {
            ...
            return leaf.emoji ? (
                ...
                <span style={isParentHeading(props) ? headingStyle : leaf.style} {...attributes} {...props}>
                    {children}
                </span>
            );
        };
        ...
        const renderTableModal = () => {
            return (
                <Modal isOpen={tableModal} toggle={toggleTableModal} backdrop="static" size="md">
                    ...
                    <ModalFooter>
                        <Button onClick={() => addTablazat(editor, modalValues.tableClass, parseInt(modalValues.rowNumber, 10), parseInt(modalValues.colNumber, 10), modalValues.textAlign)}>
                            Mentés
                        </Button>
